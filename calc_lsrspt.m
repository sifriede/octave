...
%%===== Save Results =====
if (exist('image_fits') ==0)
    mkdir 'image_fits';
endif
if (strcmp(img(end-4:end),'.tiff'))
    tmp_str = ['image_fits/' img(1:end-5)];
else 
    tmp_str = ['image_fits/' img(1:end-4)];
endif
    print(h, [tmp_str "_result.pdf"], "-dpdf");
    save([tmp_str "_fit_x.dat"], "pixel2mm", "vec_x", "int_x_n", "f_x", "p_x", "cvg_x", "iter_x", "corp_x", "covp_x", "covr_x", "stdresid_x", "Z_x", "r2_x");
    save([tmp_str "_fit_y.dat"], "pixel2mm", "vec_y", "int_y_n", "f_y", "p_y", "cvg_y", "iter_y", "corp_y", "covp_y", "covr_y", "stdresid_y", "Z_y", "r2_y");